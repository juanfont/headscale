...
func (x *ApproveRoutesRequest) Reset() {
	*x = ApproveRoutesRequest{}
	mi := &file_headscale_v1_node_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ApproveRoutesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApproveRoutesRequest) ProtoMessage() {}

func (x *ApproveRoutesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_headscale_v1_node_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApproveRoutesRequest.ProtoReflect.Descriptor instead.
func (*ApproveRoutesRequest) Descriptor() ([]byte, []int) {
	return file_headscale_v1_node_proto_rawDescGZIP(), []int{7}
}

func (x *ApproveRoutesRequest) GetNodeId() uint64 {
	if x != nil {
		return x.NodeId
	}
	return 0
...
func (x *ApproveRoutesRequest) GetRoutes() []string {
	if x != nil {
		return x.Routes
	}
	return nil
...
type ApproveRoutesResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Node          *Node                  `protobuf:"bytes,1,opt,name=node,proto3" json:"node,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ApproveRoutesResponse) Reset() {
	*x = ApproveRoutesResponse{}
	mi := &file_headscale_v1_node_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ApproveRoutesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApproveRoutesResponse) ProtoMessage() {}

func (x *ApproveRoutesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_headscale_v1_node_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApproveRoutesResponse.ProtoReflect.Descriptor instead.
func (*ApproveRoutesResponse) Descriptor() ([]byte, []int) {
	return file_headscale_v1_node_proto_rawDescGZIP(), []int{8}
}

func (x *ApproveRoutesResponse) GetNode() *Node {
	if x != nil {
		return x.Node
	}
	return nil
...
var file_headscale_v1_node_proto_rawDesc = string([]byte{
	...
	,
	...
	0x64, 0x65, 0x22, 0x2c, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4e, 0x6f, 0x64, 0x65,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x2c, 0x0a, 0x11, 0x45, 0x78, 0x70, 0x69, 0x72, 0x65,
	...
	,
...
var file_headscale_v1_node_proto_goTypes = []any{
	...
	(*ApproveRoutesRequest)(nil),    // 8: headscale.v1.ApproveRoutesRequest
	(*ApproveRoutesResponse)(nil),   // 9: headscale.v1.ApproveRoutesResponse
...
var file_headscale_v1_node_proto_depIdxs = []int32{
	...
	1,  // 9: headscale.v1.ApproveRoutesResponse.node:type_name -> headscale.v1.Node
