...
type Node struct {
	...
	Approved       bool                   `protobuf:"varint,23,opt,name=approved,proto3" json:"approved,omitempty"`
}
...
func (x *ApproveNodeRequest) GetNodeId() uint64 {
	if x != nil {
		return x.NodeId
	}
	return 0
...
func (x *ApproveNodeResponse) GetNode() *Node {
	if x != nil {
		return x.Node
	}
	return nil
...
var file_headscale_v1_node_proto_rawDesc = []byte{
	...
	0x22, 0xbb, 0x05, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x6f, 0x6e, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76,
	0x65, 0x64, 0x18, 0x17, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76,
	0x65, 0x64, 0x4a, 0x04, 0x08, 0x09, 0x10, 0x0a, 0x4a, 0x04, 0x08, 0x0e, 0x10, 0x12, 0x22, 0x3b,
	...
	0x2d, 0x0a, 0x12, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x6e, 0x6f, 0x64, 0x65, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x6e, 0x6f, 0x64, 0x65, 0x49, 0x64, 0x22, 0x3d,
	0x0a, 0x13, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73,
	...
	0x76, 0x31, 0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x22, 0x2c, 0x0a,
...
var file_headscale_v1_node_proto_goTypes = []any{
	...
	(*ApproveNodeRequest)(nil),      // 10: headscale.v1.ApproveNodeRequest
	(*ApproveNodeResponse)(nil),     // 11: headscale.v1.ApproveNodeResponse
...
var file_headscale_v1_node_proto_depIdxs = []int32{
	...
	1,  // 9: headscale.v1.ApproveNodeResponse.node:type_name -> headscale.v1.Node
...
func file_headscale_v1_node_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_headscale_v1_node_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*ApproveNodeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_headscale_v1_node_proto_msgTypes[10].Exporter = func(v any, i int) any {
			switch v := v.(*ApproveNodeResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
