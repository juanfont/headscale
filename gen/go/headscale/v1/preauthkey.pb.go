...
type ExpirePreAuthKeyRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	User  uint64                 `protobuf:"varint,1,opt,name=user,proto3" json:"user,omitempty"`
	// Either key or key_id must be provided, but not both
	Key           *string `protobuf:"bytes,2,opt,name=key,proto3,oneof" json:"key,omitempty"`
	KeyId         *uint64 `protobuf:"varint,3,opt,name=key_id,json=keyId,proto3,oneof" json:"key_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExpirePreAuthKeyRequest) GetKeyId() uint64 {
...
const file_headscale_v1_preauthkey_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\x04R\x04user\x12\x15\n" +
	"\x03key\x18\x02 \x01(\tH\x00R\x03key\x88\x01\x01\x12\x1a\n" +
	"\x06key_id\x18\x03 \x01(\x04H\x01R\x05keyId\x88\x01\x01B\x06\n" +
	"\x04_keyB\t\n" +
	"\a_key_id\"\x1a\n" +
