...
type PreAuthKey struct {
	...
	Resuable   bool                   `protobuf:"varint,4,opt,name=resuable,proto3" json:"resuable,omitempty"`
...
func (x *PreAuthKey) GetResuable() bool {
	if x != nil {
		return x.Resuable
	}
	return false
...
type CreatePreAuthKeyRequest struct {
	...
	Namespace  string                 `protobuf:"bytes,1,opt,name=namespace,proto3" json:"namespace,omitempty"`
	Resuable   bool                   `protobuf:"varint,2,opt,name=resuable,proto3" json:"resuable,omitempty"`
...
func (x *CreatePreAuthKeyRequest) GetResuable() bool {
	if x != nil {
		return x.Resuable
	}
	return false
...
var file_headscale_v1_preauthkey_proto_rawDesc = []byte{
	...
	0x08, 0x72, 0x65, 0x73, 0x75, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x08, 0x72, 0x65, 0x73, 0x75, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x70, 0x68,
	...
	0x72, 0x65, 0x73, 0x75, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08,
	0x72, 0x65, 0x73, 0x75, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x65, 0x70, 0x68, 0x65,
