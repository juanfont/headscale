...
const file_headscale_v1_headscale_proto_rawDesc = "" +
	...
	"\x15database_connectivity\x18\x01 \x01(\bR\x14databaseConnectivity2\xfc\x1a\n" +
	...
	"\aGetNode\x12\x1c.headscale.v1.GetNodeRequest\x1a\x1d.headscale.v1.GetNodeResponse\"\x1e\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v1/node/{node_id}\x12\x8e\x01\n" +
	"\x10GetNodeByNodeKey\x12%.headscale.v1.GetNodeByNodeKeyRequest\x1a&.headscale.v1.GetNodeByNodeKeyResponse\"+\x82\xd3\xe4\x93\x02%\x12#/api/v1/node/by-node-key/{node_key}\x12n\n" +
...
var file_headscale_v1_headscale_proto_goTypes = []any{
	...
	(*GetNodeByNodeKeyRequest)(nil),   // 12: headscale.v1.GetNodeByNodeKeyRequest
	...
	(*AuthRegisterRequest)(nil),       // 21: headscale.v1.AuthRegisterRequest
	(*AuthApproveRequest)(nil),        // 22: headscale.v1.AuthApproveRequest
	(*AuthRejectRequest)(nil),         // 23: headscale.v1.AuthRejectRequest
	...
	(*GetNodeByNodeKeyResponse)(nil),  // 40: headscale.v1.GetNodeByNodeKeyResponse
	(*SetTagsResponse)(nil),           // 41: headscale.v1.SetTagsResponse
	(*SetApprovedRoutesResponse)(nil), // 42: headscale.v1.SetApprovedRoutesResponse
	(*RegisterNodeResponse)(nil),      // 43: headscale.v1.RegisterNodeResponse
	(*DeleteNodeResponse)(nil),        // 44: headscale.v1.DeleteNodeResponse
	(*ExpireNodeResponse)(nil),        // 45: headscale.v1.ExpireNodeResponse
	(*RenameNodeResponse)(nil),        // 46: headscale.v1.RenameNodeResponse
	(*ListNodesResponse)(nil),         // 47: headscale.v1.ListNodesResponse
	(*BackfillNodeIPsResponse)(nil),   // 48: headscale.v1.BackfillNodeIPsResponse
	(*AuthRegisterResponse)(nil),      // 49: headscale.v1.AuthRegisterResponse
	(*AuthApproveResponse)(nil),       // 50: headscale.v1.AuthApproveResponse
	(*AuthRejectResponse)(nil),        // 51: headscale.v1.AuthRejectResponse
...
var file_headscale_v1_headscale_proto_depIdxs = []int32{
	...
	12, // 10: headscale.v1.HeadscaleService.GetNodeByNodeKey:input_type -> headscale.v1.GetNodeByNodeKeyRequest
	...
	21, // 19: headscale.v1.HeadscaleService.AuthRegister:input_type -> headscale.v1.AuthRegisterRequest
	22, // 20: headscale.v1.HeadscaleService.AuthApprove:input_type -> headscale.v1.AuthApproveRequest
	23, // 21: headscale.v1.HeadscaleService.AuthReject:input_type -> headscale.v1.AuthRejectRequest
	24, // 22: headscale.v1.HeadscaleService.CreateApiKey:input_type -> headscale.v1.CreateApiKeyRequest
	25, // 23: headscale.v1.HeadscaleService.ExpireApiKey:input_type -> headscale.v1.ExpireApiKeyRequest
	26, // 24: headscale.v1.HeadscaleService.ListApiKeys:input_type -> headscale.v1.ListApiKeysRequest
	27, // 25: headscale.v1.HeadscaleService.DeleteApiKey:input_type -> headscale.v1.DeleteApiKeyRequest
	28, // 26: headscale.v1.HeadscaleService.GetPolicy:input_type -> headscale.v1.GetPolicyRequest
	29, // 27: headscale.v1.HeadscaleService.SetPolicy:input_type -> headscale.v1.SetPolicyRequest
	...
	40, // 39: headscale.v1.HeadscaleService.GetNodeByNodeKey:output_type -> headscale.v1.GetNodeByNodeKeyResponse
	41, // 40: headscale.v1.HeadscaleService.SetTags:output_type -> headscale.v1.SetTagsResponse
	42, // 41: headscale.v1.HeadscaleService.SetApprovedRoutes:output_type -> headscale.v1.SetApprovedRoutesResponse
	43, // 42: headscale.v1.HeadscaleService.RegisterNode:output_type -> headscale.v1.RegisterNodeResponse
	44, // 43: headscale.v1.HeadscaleService.DeleteNode:output_type -> headscale.v1.DeleteNodeResponse
	45, // 44: headscale.v1.HeadscaleService.ExpireNode:output_type -> headscale.v1.ExpireNodeResponse
	46, // 45: headscale.v1.HeadscaleService.RenameNode:output_type -> headscale.v1.RenameNodeResponse
	47, // 46: headscale.v1.HeadscaleService.ListNodes:output_type -> headscale.v1.ListNodesResponse
	48, // 47: headscale.v1.HeadscaleService.BackfillNodeIPs:output_type -> headscale.v1.BackfillNodeIPsResponse
	49, // 48: headscale.v1.HeadscaleService.AuthRegister:output_type -> headscale.v1.AuthRegisterResponse
	50, // 49: headscale.v1.HeadscaleService.AuthApprove:output_type -> headscale.v1.AuthApproveResponse
	51, // 50: headscale.v1.HeadscaleService.AuthReject:output_type -> headscale.v1.AuthRejectResponse
	52, // 51: headscale.v1.HeadscaleService.CreateApiKey:output_type -> headscale.v1.CreateApiKeyResponse
	53, // 52: headscale.v1.HeadscaleService.ExpireApiKey:output_type -> headscale.v1.ExpireApiKeyResponse
	54, // 53: headscale.v1.HeadscaleService.ListApiKeys:output_type -> headscale.v1.ListApiKeysResponse
	55, // 54: headscale.v1.HeadscaleService.DeleteApiKey:output_type -> headscale.v1.DeleteApiKeyResponse
	56, // 55: headscale.v1.HeadscaleService.GetPolicy:output_type -> headscale.v1.GetPolicyResponse
	57, // 56: headscale.v1.HeadscaleService.SetPolicy:output_type -> headscale.v1.SetPolicyResponse
