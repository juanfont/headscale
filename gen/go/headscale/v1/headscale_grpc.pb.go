...
func (c *headscaleServiceClient) GetACL(ctx context.Context, in *GetACLRequest, opts ...grpc.CallOption) (*GetACLResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/headscale.v1.HeadscaleService/GetACL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *headscaleServiceClient) SetACL(ctx context.Context, in *SetACLRequest, opts ...grpc.CallOption) (*SetACLResponse, error) {
	out := new(SetACLResponse)
	err := c.cc.Invoke(ctx, "/headscale.v1.HeadscaleService/SetACL", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHeadscaleServiceServer) SetACL(context.Context, *SetACLRequest) (*SetACLResponse, error) {
...
func _HeadscaleService_GetACL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/headscale.v1.HeadscaleService/GetACL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HeadscaleService_SetACL_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetACLRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HeadscaleServiceServer).SetACL(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/headscale.v1.HeadscaleService/SetACL",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeadscaleServiceServer).SetACL(ctx, req.(*SetACLRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HeadscaleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetACL",
			Handler:    _HeadscaleService_SetACL_Handler,
		},
	},
