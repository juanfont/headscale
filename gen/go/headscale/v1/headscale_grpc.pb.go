...
const (
	...
	HeadscaleService_GetNodeByNodeKey_FullMethodName  = "/headscale.v1.HeadscaleService/GetNodeByNodeKey"
...
type HeadscaleServiceClient interface {
	...
	GetNodeByNodeKey(ctx context.Context, in *GetNodeByNodeKeyRequest, opts ...grpc.CallOption) (*GetNodeByNodeKeyResponse, error)
...
func (c *headscaleServiceClient) GetNodeByNodeKey(ctx context.Context, in *GetNodeByNodeKeyRequest, opts ...grpc.CallOption) (*GetNodeByNodeKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetNodeByNodeKeyResponse)
	err := c.cc.Invoke(ctx, HeadscaleService_GetNodeByNodeKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HeadscaleServiceServer interface {
	...
	GetNodeByNodeKey(context.Context, *GetNodeByNodeKeyRequest) (*GetNodeByNodeKeyResponse, error)
...
func (UnimplementedHeadscaleServiceServer) GetNodeByNodeKey(context.Context, *GetNodeByNodeKeyRequest) (*GetNodeByNodeKeyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetNodeByNodeKey not implemented")
}
...
func _HeadscaleService_GetNodeByNodeKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNodeByNodeKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HeadscaleServiceServer).GetNodeByNodeKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HeadscaleService_GetNodeByNodeKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeadscaleServiceServer).GetNodeByNodeKey(ctx, req.(*GetNodeByNodeKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HeadscaleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNodeByNodeKey",
			Handler:    _HeadscaleService_GetNodeByNodeKey_Handler,
		},
		{
			MethodName: "SetTags",
