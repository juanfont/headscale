...
func TestACLTagPropagation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			}, 10*time.Second, 500*time.Millisecond, "verifying initial NetMap visibility")
			...
			}, 30*time.Second, 500*time.Millisecond, "verifying NetMap visibility propagated after tag change")
