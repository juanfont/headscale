...
- `headscale users destroy`/`rename` now report "no user matches query" when the name or ID matches nobody, instead of "multiple users match query", and reject `--identifier 0`
