...
- **Tags**: The gRPC `SetTags` endpoint now prevents setting tags on user-owned nodes. Only nodes registered with tagged PreAuthKeys can have tags modified via the API.
