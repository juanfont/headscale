...
func (h *Headscale) Serve() error {
	...
	h.mapBatcher = mapper.NewBatcherAndMapper(h.cfg, h.state) // Default (LockFree)
	// h.mapBatcher = mapper.NewBatcherLockAndMapper(h.cfg, h.state)   // Lock-based implementation
