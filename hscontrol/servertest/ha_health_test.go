...
// while the client is briefly disconnected. With the SessionEpoch
// guard in [HAHealthProber.ProbeOnce], the timeout path observes the
// epoch bump from the reconnect and bails out instead of installing a
// spurious Unhealthy bit.
//
